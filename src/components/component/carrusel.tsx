...
* @see https://v0.dev/t/fiK4aJpDeA3
...
export function Carrusel() {
  return (
    <section className="bg-background py-12 md:py-16 lg:py-1">
            ...
            <CarouselContent>
              <CarouselItem>
                <div className="relative">
                  ...
                  <Link
                    href="#"
                    className="absolute bottom-4 right-4 inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground focus:outline-none"
                    prefetch={false}
                  >
                    Ver más
