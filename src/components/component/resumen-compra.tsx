              ...
              <TableBody>
                {productos.map((producto, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell>${formatPrice(parseFloat(producto.PrecioProducto).toFixed(2))}</TableCell>
                    <TableCell className="font-semibold">${formatPrice((producto.cantidad * parseFloat(producto.PrecioProducto)).toFixed(2))}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">${formatPrice(shipping.toFixed(2))}</span>
                </div>
                <Separator />
              ...
              <CardFooter>
                <Button onClick={handleConfirmarCompra} className="w-full" size="lg">
