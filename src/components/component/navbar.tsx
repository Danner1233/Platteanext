      ...
      <Sheet>
        ...
        <SheetContent side="left">
          ...
          <div className="grid gap-2 py-6">
            <Link href="/shops" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
              Tiendas
            </Link>
            <Link href="/products" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
              Productos
            </Link>
            <Link href="/workwithus" className="flex w-full items-center py-2 text-lg font-semibold" prefetch={false}>
              Trabaja con nosotros
            </Link>
          </div>
        </SheetContent>
...
function NotificationIcon(props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
